    ...
    <>
      <div className='bg-[#323946]'  >
        ...
        <div className='mt-28  flex-col justify-center items-center md:flex-row  flex gap-5'>
            ...
            <div className='h-[14rem] w-[23rem] mb-28 bg-[#BF8BF1] hover:bg-[#a558ec] text-center rounded-2xl text-rose-600'> <p className='text-3xl font-serif mt-20 font-bold cursor-pointer'>12th</p> <p className='text-xl font-serif'>B.B.S.S.M. Inter College,Meerut</p> </div>
