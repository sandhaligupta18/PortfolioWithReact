...
function About() {
  return (
    <>
      ...
      <div className='text-white text-5xl  font-serif flex justify-center pt-24' >  About <span className='text-rose-600'> Me</span>  </div>
      <div className='flex gap-8'>
        <div className='mt-11 ml-16'>  

        <img src={image} alt="" height={500}  width={600}/>
        </div>
        
        <div className='flex-row '>
        <div className='mt-32 mr-9 text-white font-serif'>
          ...
          <div className='ml-28   flex gap-20 mt-10'>
...
<div className='h-24 w-32 p-6 cursor-pointer transition duration-500 hover:scale-125  rounded-[50%] bg-[#1F242D] border-2 border-rose-600 font-bold text-white'>5+ <span className='text-rose-600'>Certificates</span></div>
      ...
      <div >
        <button className='mt-9 hover:shadow-none ml-24 h-10 mb-12 w-28 shadow-rose-600 shadow-lg rounded-[30px] font-serif font-bold bg-rose-600 text-slate-600'>Hire Me</button>
      </div>
